...
<div class="card"> 
 ...
 <button onclick="location.href='ReportPdf.php';" id="reportpdf">Download Pdf</button>
    <button onclick="location.href='ReportExcel.php';" id="reportexcel">Download excel</button>
 </div>
</div>
</div>
</div>
